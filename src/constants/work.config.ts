export default [
  {
    heading: "Sylva",
    description: "Sylva is on a mission to build belonging by operating and nurturing niche online communities. As a part of my work with Sylva, I gained insights into multi-tenant architectures and enhanced skills through no-code tools. Addressed data discrepancies across multiple platforms and actively involved in the internal project.",
    defaultState: true,
  },
  {
    heading: "Antler",
