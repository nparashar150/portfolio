  ...
  work: [
    {
      ...
      company: "Ringg AI",
      desc: "There since day 0. Voice AI platforms: RinggAI (AI calling) and DesiVocal (AI TTS, 6M+ generations).",
      tech: ["React", "Next.js", "TypeScript", "AWS", "Remotion"],
    },
    {
      period: "2022 → Now",
      role: "Product Engineer",
      company: "Sylva, NY",
      desc: "Product engineering with cross-functional teams and stakeholders: built Miitra, drove product exchange, and ran point chief-of-staff style across the roadmap.",
